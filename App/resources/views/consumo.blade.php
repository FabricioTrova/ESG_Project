                                            ...
                                            @foreach ($consumos as $consumo)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form action="{{ route('consumos.destroy', $consumo->id) }}"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="registroForm" action="{{ route('consumos.store') }}"
                                                method="POST">
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    <label for="fonte_consumo_id" class="font-weight-bold">Fonte de
                                                        Consumo</label>
                                                    <select class="form-control" id="fonte_consumo_id"
                                                        name="fonte_consumo_id" required>
                                                        ...
                                                        @else{
                                                            <option value="" disabled>Nenhuma fonte disponível
                                                        }   </option>
                                                        @endif
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label for="quantidade_consumida"
                                                        class="font-weight-bold">Quantidade Consumida</label>
                                                    <input type="number" step="0.01" class="form-control"
                                                        id="quantidade_consumida" name="quantidade_consumida"
                                                        required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="data_referencia" class="font-weight-bold">Data de
                                                        Registro</label>
                                                    <input type="date" class="form-control" id="data_referencia"
                                                        name="data_referencia" required>
                                                </div>
                                            </form>
                                        </div>
                        ...
                        <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">Selecione 'Sair' abaixo se estiver pronto para encerrar sua
                                        sessão atual.</div>
                                    <div class="modal-footer">
