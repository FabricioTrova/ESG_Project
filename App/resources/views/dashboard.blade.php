                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    ...
                                    <p class="text-gray-600 small">01/05/2025 - 20% menos CO2 com energia solar.</p>
                                </li>
                                <li class="list-group-item">
                                    <h6 class="font-weight-bold">Compensação de Carbono</h6>
                                    <p class="text-gray-600 small">15/05/2025 - 5.000 tCO2 compensadas via reflorestamento.</p>
                                </li>
                                <li class="list-group-item">
                                    <h6 class="font-weight-bold">Eficiência Energética</h6>
                                    <p class="text-gray-600 small">20/04/2025 - Nova auditoria reduziu 15% do consumo.</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    ...
                                    <p class="text-gray-600 small">15/06/2025 - Reduzir 30% de emissões no Q3.</p>
                                </li>
                                <li class="list-group-item">
                                    <h6 class="font-weight-bold">Relatório de Carbono</h6>
                                    <p class="text-gray-600 small">01/07/2025 - Publicação do relatório anual.</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card border-left-success shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Redução de CO2</div>
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="card border-left-success shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Carbono Compensado</div>
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="card border-left-success shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Energia Renovável</div>
